...
if __name__ == '__main__':
    # load model
    face_detector = FaceDetector("facenet", "PosturalRecognition/models/facenet.npz")
    ...
    while True:
        ...
        if len(facerects) > 0:
            for facerect in facerects:
                cv2.rectangle(res_img, (facerect[0], facerect[1]),
                              (facerect[0] + facerect[2], facerect[1] + facerect[3]), (255, 255, 255), 1)
